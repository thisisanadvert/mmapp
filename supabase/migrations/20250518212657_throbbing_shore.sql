/*
  ...
  1. Changes
    - Completely rewrite building_users policies to avoid recursion
    - Use direct comparisons instead of self-referencing subqueries
    - Fix storage policies for documents bucket
    - Ensure proper access for demo and development environments
